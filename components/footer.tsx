        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
         ...
         <div className="text-center md:-mt-3">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col items-center gap-2 text-base text-gray-700">
              <a
                href="/privacy-policy"
                className="hover:text-blue-600 transition-colors"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 font-medium text-primary hover:text-blue-600 transition-colors"
                target="_blank"
