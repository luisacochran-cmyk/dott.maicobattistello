...
export default function MedicinaLegaleschioPage() {
  ...
  <p>
    <p>
  Il Dr. Maico Battistello svolge attività di medicina legale a Schio, offrendo consulenze medico-legali rivolte a privati, professionisti, studi legali e compagnie assicurative di Marostica, Bassano del Grappa e dei comuni limitrofi.
</p>
  </p>
